...
set "RUNTIME_VERSION=26.2-loader-%LOADER_VERSION%-api-0.154.2"
set "FABRIC_URL=https://meta.fabricmc.net/v2/versions/loader/26.2/%LOADER_VERSION%/1.1.1/server/jar"
set "API_MIRROR=https://cdn.modrinth.com/data/P7dR8mSH/versions/Kr4WG5mG/fabric-api-0.154.2+26.2.jar"
set "API_FALLBACK=https://maven.fabricmc.net/net/fabricmc/fabric-api/fabric-api/0.154.2+26.2/fabric-api-0.154.2+26.2.jar"
...
set "HAS_MANUAL_JAVA="
set /p "HAS_MANUAL_JAVA=Java was not detected. Do you already have GraalVM/JDK 25? [y/N]: "
...
:java_ready
echo [2/3] Installing Minecraft 26.2 runtime...
...
echo The selected path is not a compatible Java 25 installation. Continuing with download.
exit /b 0
